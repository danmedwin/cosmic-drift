      ...
      React.createElement("div", { style: { flex: 1, overflowY: "auto", padding: "8px 10px 6px", display: "flex", flexDirection: "column", gap: 8 } },
        ...
        React.createElement(WsPanel, { style: { padding: "10px", display: "flex", flexDirection: "column" } },
          ...
          React.createElement("div", { style: { display: "grid", gridTemplateColumns: "3fr 1fr", gridTemplateRows: "repeat(5, auto)", gridAutoFlow: "column", gap: 6, flex: 1 } },
            ...
            React.createElement("div", { onClick: function() { setScreen("designer"); setBdCurrentView("list"); setBdSavedTab("active"); }, style: { background: "linear-gradient(160deg, rgba(8,18,32,0.95) 0%, rgba(5,12,24,0.98) 100%)", border: "1px solid rgba(200,184,255,0.22)", borderTop: "3px solid #c8b8ff", borderRadius: 7, padding: "7px 8px", cursor: "pointer" } },
              React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 3, marginBottom: 4 } },
            ...
            React.createElement("div", { onClick: function() { setScreen("vfx"); setVfxCurrentView("list"); setVfxSavedTab("active"); }, style: { background: "linear-gradient(160deg, rgba(8,18,32,0.95) 0%, rgba(5,12,24,0.98) 100%)", border: "1px solid rgba(255,180,60,0.22)", borderTop: "3px solid #ffb43c", borderRadius: 7, padding: "7px 8px", cursor: "pointer" } },
              React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 3, marginBottom: 4 } },
            ...
            React.createElement("div", { onClick: function() { setScreen("ufo"); var ad = ufoGetActiveDesign(); if (ad) ufoOpenEditor(ad); else setUfoView("list"); }, style: { background: "linear-gradient(160deg, rgba(8,18,32,0.95) 0%, rgba(5,12,24,0.98) 100%)", border: "1px solid rgba(100,220,180,0.22)", borderTop: "3px solid #64dcb4", borderRadius: 7, padding: "7px 8px", cursor: "pointer" } },
              React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 3, marginBottom: 4 } },
        ...
        React.createElement("div", { style: { flex: 1, overflowY: "auto", padding: "0 16px 32px" } },
          ...
          React.createElement("div", { ref: shipPreviewStickyRef, style: { position: "sticky", top: 0, zIndex: 5, display: "flex", flexDirection: "column", alignItems: "center", padding: "12px 0 10px", margin: "0 -16px", background: "rgba(14,18,28,0.92)", backdropFilter: "blur(4px)", WebkitBackdropFilter: "blur(4px)", borderBottom: "1px solid rgba(255,138,170,0.12)" } },
            React.createElement("div", { style: { position: "relative", display: "inline-block" } },
              React.createElement("div", {
                style: { width: shipPreviewSize, height: shipPreviewSize, padding: 4, borderRadius: 12, background: "rgba(0,0,0,0.25)", border: "1px solid rgba(255,138,170,0.15)", touchAction: "none", cursor: shipTab !== "templates" ? "crosshair" : "default" },
                ...
                React.createElement(ShipDesignSvg, { size: shipPreviewSize - 8, design: shipEdit, uid: "edit", selectedIdx: shipTab !== "templates" ? shipSelectedPart : -1, style: shipEdit.glowEnabled ? { filter: "drop-shadow(0 0 " + (shipEdit.glowIntensity || 10) + "px " + (shipEdit.glowColor || "#ff88aa") + ")" } : {} })),
              React.createElement("div", {
